...
<body class='Contenido-signup'>
    <div id='signup-container'>
        ...
        <form class="signup-form" method="POST" action="procesar_signup.php">
            ...
            <input type="text" id="nombres" name="nombre" value="<?= htmlspecialchars($usuario_nombre) ?>" required>

            <label for="apellidos">Apellidos:</label>
            <input type="text" id="apellidos" name="apellido" value="<?= htmlspecialchars($usuario_apellido) ?>" required>

            <label for="tipoDocumento">Tipo de documento:</label>
            <select id="tipoDocumento" name="tipo_documento_id" required>
            ...
            <input type="text" id="numeroDocumento" name="numero_documento" value="<?= htmlspecialchars($usuario_numero_documento) ?>" required>

            <label for="telefono">Teléfono:</label>
            <input type="tel" id="telefono" name="telefono" value="<?= htmlspecialchars($usuario_telefono) ?>" required>
            ...
            <input type="text" id="usuarios" name="nombre_usuario" value="<?= htmlspecialchars($usuario_nombre_usuario) ?>" required>
