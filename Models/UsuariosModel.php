...
class UsuariosModel
{
    ...
    public function save()
    {
        ...
        $stmt->bind_param('ssisssssi', $this->nombre, $this->apellido, $this->tipo_documento_id, $this->numero_documento, $this->telefono, $this->email, $this->nombre_usuario, $hashed_password, $this->rol_id);
